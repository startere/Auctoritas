...
AuctoritasPlayer::AuctoritasPlayer(const FObjectInitializer& ObjectInitializer)
...
void AuctoritasPlayer::ChangeCameraArmLength(float changeValue)
{
	CameraBoom->TargetArmLength += changeValue * 100.0f; // Change 100.0f when changing zoop speed
}

void AuctoritasPlayer::RotateCameraArm(FRotator rotation) 
{
	CameraBoom->AddRelativeRotation(rotation);
}

void AuctoritasPlayer::MovePlayerForward(float changeValue)
{
	AddMovementInput(GetActorForwardVector(), changeValue);
}

void AuctoritasPlayer::MovePlayerRight(float changeValue) 
{
	AddMovementInput(GetActorRightVector(), changeValue);
}

void AuctoritasPlayer::Tick(float DeltaSeconds)
{
